...
#define STRING_CONFIG_H_AUTHOR "(Bryan065)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3 SKR Mini"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender-3 Pro MK3s+E3D+Volcano
  #define DEFAULT_Kp 19.12
  #define DEFAULT_Ki 1.58
  #define DEFAULT_Kd 57.96
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //24v heater into steel bed+4mm borosilicate glass
  #define DEFAULT_bedKp 213.90
  #define DEFAULT_bedKi 42.11
  #define DEFAULT_bedKd 724.25
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 403, 140 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 40, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, -2, -2.55 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (Y_CENTER + 14)  // Y point for Z homing
#endif
